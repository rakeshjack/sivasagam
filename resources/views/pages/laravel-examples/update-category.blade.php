                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2" style="margin:2%">
                            <form method='POST' action="{{ route('save-categories') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" name="name" class="form-control border border-2 p-2" value='{{ old('name', $categories->name) }}'>
                                        @error('name')
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" name="fullname" class="form-control border border-2 p-2" value='{{ old('fullname', $categories->fullname) }}'>
                                        @error('fullname')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                    </div>
                                    ...
                                    <!-- <div class="mb-3 col-md-6">
                                        ...
                                        <input type="file" name="images[]" class="form-control border border-2 p-2" multiple>
                                    </div> -->
